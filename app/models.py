...
class AvailabilityRequest(BaseModel):
    ...
    check_out: date = Field(..., description="Check-out date (inclusive)")
...
class ConnectionCheckRequest(BaseModel):
    ...
    spreadsheet_id: Optional[str] = Field(None, description="Optional spreadsheet ID to test access. If not provided, only checks authentication.")
